...
type ArtworkShareModalProps = {
  artworkTitle: string;
  artistName: string;
  triggerClassName?: string;
};

function shareUrls(pageUrl: string, artworkTitle: string, artistName: string) {
  const line = `${artworkTitle} — ${artistName}: ${pageUrl}`;
...
export function ArtworkShareModal({
  artworkTitle,
  artistName,
  triggerClassName,
}: ArtworkShareModalProps) {
